  ...
  <div class="content-wrapper">
    ...
    ?>
    <form action="<?php echo site_url('admin/slideshow/ubah/' . $data->id);?>" method="post" class="form-horizontal" enctype="multipart/form-data">
    <div class="row">
      <div class="col-md-12">
        <!-- Default box -->
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group <?php echo (form_error('judul')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="judul" name="judul" placeholder="Judul" value="<?php echo set_value('judul', $data->judul); ?>">
            ...
            <div class="form-group <?php echo (form_error('deskripsi')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Deskripsi" value="<?php echo set_value('deskripsi', $data->deskripsi); ?>">
            ...
            <div class="form-group <?php echo (form_error('tampil')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                  <div class="radio">
                    <label>
                      <input type="radio" name="tampil" id="tampil" value="Y" <?php echo (set_value('tampil', $data->tampil) == 'Y') ? 'checked' : ''; ?>>
                      Ya
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="tampil" id="tampil" value="T" <?php echo (set_value('tampil', $data->tampil) == 'T') ? 'checked' : ''; ?>>
                      Tidak
                    </label>
                  </div>
              </div>
