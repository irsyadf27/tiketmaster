  ...
  <div class="content-wrapper">
    ...
    ?>
    <form action="<?php echo site_url('admin/user/tambah');?>" method="post" class="form-horizontal">
    <div class="row">
      <div class="col-md-6">
        <!-- Default box -->
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="form-group <?php echo (form_error('nama_depan')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nama_depan" name="nama_depan" placeholder="Nama Depan" value="<?php echo set_value('nama_depan'); ?>">
            ...
            <div class="form-group <?php echo (form_error('nama_belakang')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="nama_belakang" name="nama_belakang" placeholder="Nama Belakang" value="<?php echo set_value('nama_belakang'); ?>">
            ...
            <div class="form-group <?php echo (form_error('no_hp')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="No. HP" value="<?php echo set_value('no_hp'); ?>">
            ...
            <div class="form-group <?php echo (form_error('jenis')) ? 'has-error' : '';?>">
              ...
              <div class="col-sm-10">
                <select name="jenis" class="form-control">
                  <option value="user" <?php echo (set_value('jenis') == 'user') ? 'selected' : ''; ?>>User</option>
                  <option value="admin" <?php echo (set_value('jenis') == 'admin') ? 'selected' : ''; ?>>Admin</option>
                </select>
